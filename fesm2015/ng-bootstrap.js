import { Injectable, ChangeDetectionStrategy, Component, Input, ViewEncapsulation, TemplateRef, Output, EventEmitter, NgModule, Inject, LOCALE_ID, InjectionToken, ChangeDetectorRef, ContentChildren, Directive, NgZone, PLATFORM_ID, Injector, Renderer2, ElementRef, ViewContainerRef, ComponentFactoryResolver, forwardRef, ContentChild, Host, Optional, defineInjectable, inject, ApplicationRef, RendererFactory2, INJECTOR, ViewChild } from '@angular/core';
